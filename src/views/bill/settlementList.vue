  ...
  <div class="shopping-detail">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <p>运费：&yen;{{scope.row.item_sn.fee}}</p>
          <p>商品：&yen;{{scope.row.item_sn.shop}}</p>
        </template>
      </el-table-column>
      ...
      <el-table-column
        ...
        min-width="100">
        <template slot-scope="scope">
          <el-input v-model="scope.row.changePrice"></el-input>
        </template>
      </el-table-column>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="seeDetail(scope.$index, scope.row)">结算</el-button>
        </template>
      </el-table-column>
    ...
    <div class="bottom">
      <div style="margin-top: 20px">
        ...
        <el-button @click="reviewPassed()">批量结算</el-button>
      </div>
      <div class="the-page">
        <el-pagination
    ...
    methods: {
      ...
      reviewPassed() {
        ...
        for (let i = 0; i < this.checkList.length; i++) {
          for (let j = 0; j < this.listDetail.length; j++) {
            if (this.checkList[i].id === this.listDetail[j].id) {
              this.listDetail.splice(j, 1)
              continue
            }
          }
        }
        this.$refs.multipleTable.clearSelection();0
      },
